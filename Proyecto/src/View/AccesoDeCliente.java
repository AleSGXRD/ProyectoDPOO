...
public class AccesoDeCliente extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(UserName.getText().isEmpty()||UserPass.getPassword().length==0){
            ...
            Error.setText("");
            Vector<Usuario> sesions = new Vector<Usuario>();
            try{
                sesions = GestionDeCuentas.CargarDatos(false);
            }
            catch(Exception ex){
            ...
            try{
                ...
                sesions.add(GestionDeCuentas.Login_Client(name,pass));
                GestionDeCuentas.GuardarDatos(sesions, false);
            }
            catch(Exception ex){
